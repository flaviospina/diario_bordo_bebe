...
/**
 * Tabelas LMS dos padrões de crescimento infantil da OMS (0–60 meses),
 * por sexo: peso-para-idade, comprimento/altura-para-idade e perímetro
 * cefálico-para-idade. Fonte: WHO Child Growth Standards (2006).
 * Congeladas no repositório: relatórios já emitidos não podem mudar
 * se a referência for atualizada — o percentil é gravado na medição.
 * Formato: [tipo][sexo][mes] => [L, M, S]
 */
...
return [
    ...
    'pc' => [
        'masculino' => [
            ...
            2 => [1.0, 39.1285, 0.02997],
            3 => [1.0, 40.5135, 0.02918],
            4 => [1.0, 41.6317, 0.02868],
            5 => [1.0, 42.5576, 0.02837],
            6 => [1.0, 43.3306, 0.02817],
            7 => [1.0, 43.9803, 0.02804],
            8 => [1.0, 44.53, 0.02796],
            9 => [1.0, 44.9998, 0.02792],
            10 => [1.0, 45.4051, 0.0279],
            11 => [1.0, 45.7573, 0.02789],
            12 => [1.0, 46.0661, 0.02789],
            13 => [1.0, 46.3395, 0.02789],
            14 => [1.0, 46.5844, 0.02791],
            15 => [1.0, 46.806, 0.02792],
            16 => [1.0, 47.0088, 0.02795],
            17 => [1.0, 47.1962, 0.02797],
            18 => [1.0, 47.3711, 0.028],
            19 => [1.0, 47.5357, 0.02803],
            20 => [1.0, 47.6919, 0.02806],
            21 => [1.0, 47.8408, 0.0281],
            22 => [1.0, 47.9833, 0.02813],
            23 => [1.0, 48.1201, 0.02817],
            24 => [1.0, 48.2515, 0.02821],
            25 => [1.0, 48.3777, 0.02825],
            26 => [1.0, 48.4989, 0.0283],
            27 => [1.0, 48.6151, 0.02834],
            28 => [1.0, 48.7264, 0.02838],
            29 => [1.0, 48.8331, 0.02842],
            30 => [1.0, 48.9351, 0.02847],
            31 => [1.0, 49.0327, 0.02851],
            32 => [1.0, 49.126, 0.02855],
            33 => [1.0, 49.2153, 0.02859],
            34 => [1.0, 49.3007, 0.02863],
            35 => [1.0, 49.3826, 0.02867],
            36 => [1.0, 49.4612, 0.02871],
            37 => [1.0, 49.5367, 0.02875],
            38 => [1.0, 49.6093, 0.02878],
            39 => [1.0, 49.6791, 0.02882],
            40 => [1.0, 49.7465, 0.02886],
            41 => [1.0, 49.8116, 0.02889],
            42 => [1.0, 49.8745, 0.02893],
            43 => [1.0, 49.9354, 0.02896],
            44 => [1.0, 49.9942, 0.02899],
            45 => [1.0, 50.0512, 0.02903],
            46 => [1.0, 50.1064, 0.02906],
            47 => [1.0, 50.1598, 0.02909],
            48 => [1.0, 50.2115, 0.02912],
            49 => [1.0, 50.2617, 0.02915],
            50 => [1.0, 50.3105, 0.02918],
            51 => [1.0, 50.3578, 0.02921],
            52 => [1.0, 50.4039, 0.02924],
            53 => [1.0, 50.4488, 0.02927],
            54 => [1.0, 50.4926, 0.02929],
            55 => [1.0, 50.5354, 0.02932],
            56 => [1.0, 50.5772, 0.02935],
            57 => [1.0, 50.6183, 0.02938],
            58 => [1.0, 50.6587, 0.0294],
            59 => [1.0, 50.6984, 0.02943],
            60 => [1.0, 50.7375, 0.02946],
        ],
        'feminino' => [
            0 => [1.0, 33.8787, 0.03496],
            1 => [1.0, 36.5463, 0.0321],
            2 => [1.0, 38.2521, 0.03168],
            3 => [1.0, 39.5328, 0.0314],
            4 => [1.0, 40.5817, 0.03119],
            5 => [1.0, 41.459, 0.03102],
            6 => [1.0, 42.1995, 0.03087],
            7 => [1.0, 42.829, 0.03075],
            8 => [1.0, 43.3671, 0.03063],
            9 => [1.0, 43.83, 0.03053],
            10 => [1.0, 44.2319, 0.03044],
            11 => [1.0, 44.5844, 0.03035],
            12 => [1.0, 44.8965, 0.03027],
            13 => [1.0, 45.1752, 0.03019],
            14 => [1.0, 45.4265, 0.03012],
            15 => [1.0, 45.6551, 0.03006],
            16 => [1.0, 45.865, 0.02999],
            17 => [1.0, 46.0598, 0.02993],
            18 => [1.0, 46.2424, 0.02987],
            19 => [1.0, 46.4152, 0.02982],
            20 => [1.0, 46.5801, 0.02977],
            21 => [1.0, 46.7384, 0.02972],
            22 => [1.0, 46.8913, 0.02967],
            23 => [1.0, 47.0391, 0.02962],
            24 => [1.0, 47.1822, 0.02957],
            25 => [1.0, 47.3204, 0.02953],
            26 => [1.0, 47.4536, 0.02949],
            27 => [1.0, 47.5817, 0.02945],
            28 => [1.0, 47.7045, 0.02941],
            29 => [1.0, 47.8219, 0.02937],
            30 => [1.0, 47.934, 0.02933],
            31 => [1.0, 48.041, 0.02929],
            32 => [1.0, 48.1432, 0.02926],
            33 => [1.0, 48.2408, 0.02922],
            34 => [1.0, 48.3343, 0.02919],
            35 => [1.0, 48.4239, 0.02915],
            36 => [1.0, 48.5099, 0.02912],
            37 => [1.0, 48.5926, 0.02909],
            38 => [1.0, 48.6722, 0.02906],
            39 => [1.0, 48.7489, 0.02903],
            40 => [1.0, 48.8228, 0.029],
            41 => [1.0, 48.8941, 0.02897],
            42 => [1.0, 48.9629, 0.02894],
            43 => [1.0, 49.0294, 0.02891],
            44 => [1.0, 49.0937, 0.02888],
            45 => [1.0, 49.156, 0.02886],
            46 => [1.0, 49.2164, 0.02883],
            47 => [1.0, 49.2751, 0.0288],
            48 => [1.0, 49.3321, 0.02878],
            49 => [1.0, 49.3877, 0.02875],
            50 => [1.0, 49.4419, 0.02873],
            51 => [1.0, 49.4947, 0.0287],
            52 => [1.0, 49.5464, 0.02868],
            53 => [1.0, 49.5969, 0.02865],
            54 => [1.0, 49.6464, 0.02863],
            55 => [1.0, 49.6947, 0.02861],
            56 => [1.0, 49.7421, 0.02859],
            57 => [1.0, 49.7885, 0.02856],
            58 => [1.0, 49.8341, 0.02854],
